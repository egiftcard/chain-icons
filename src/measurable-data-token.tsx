...
const MeasurableDataToken = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <style>{".st0{fill:#8acaff}.st1{fill:#4187f7}"}</style>
    <g id="Layer_1-2">
      <path
      ...
      <path
        ...
        className="st0"
      />
      <circle cx={38.4} cy={37.9} r={7.4} className="st1" />
      <circle cx={7.4} cy={20.1} r={7.4} className="st1" />
      <circle cx={7.4} cy={55.8} r={7.4} className="st1" />
      <circle cx={69.3} cy={20.1} r={7.4} className="st1" />
      <circle cx={69.3} cy={55.8} r={7.4} className="st1" />
    </g>
  </svg>
);
export default MeasurableDataToken;
