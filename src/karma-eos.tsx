...
const KarmaEos = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      ...
      >
        <stop offset={0} stopColor="#29dce8" />
        <stop offset={1} stopColor="#29dc93" />
      </linearGradient>
      <linearGradient
        xlinkHref="#a"
        id="b"
    ...
    <g data-name="Layer 2">
      <g data-name="Layer 1">
        ...
        />
        <path fill="url(#b)" d="m17.28 3-.3.3Z" />
        <path
          fill="url(#c)"
        ...
        />
        <path fill="url(#e)" d="M26.28 25Z" />
      </g>
    </g>
  </svg>
);
export default KarmaEos;
